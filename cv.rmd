...
```{r}
if (params$pdf_mode) {
  cat("Veja este CV online com links em [_arturdamiao.com/cv/cv_](https://arturdamiao.com/cv/cv)")
} else {
  cat('<a href="https://raw.githubusercontent.com/arturdamiao/blog/master/static/cv/cv.pdf" download>
         <i class="fas fa-download"></i> Baixe o PDF deste CV
       </a>')
}
```
...
Linguagens de Programação {#skills}
--------------------------------------------------------------------------------
...
<br>
<br>
_Última atualização:_ `r format(Sys.time(), '%B, %Y')`.
